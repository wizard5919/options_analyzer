...
# Enhanced sidebar
with st.sidebar:
    st.styled_text("⚙️ Configuration")
    ...
    with st.expander("⚡ Performance Tips"):
        ...
        **🚀 Speed Optimizations:**
        ...
        - Combined crawls: If the summary lists next URLs, you can browse those next. Always keep requests focused to avoid vague outputs. (type: string) (required)
...
You use render components to display content to the user in the final response. Make sure to use the following format for render components, including the `<grok:type="render_inline_citation">
